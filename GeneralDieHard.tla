...
(***************************************************************************)
(* This statement defines the sizes of the jugs as well as the target      *)
(* amount of water to defuse the bomb.                                     *)
(***************************************************************************)
CONSTANT BigJug,   \* The capacity of the bigger jug
         SmallJug, \* The capacity of the smaller jug
         Goal      \* The target amount of water

(***************************************************************************)
(* We next declare the specification's variables.                          *)
(***************************************************************************)
VARIABLES big,   \* The number of gallons of water in the bigger jug.
          small  \* The number of gallons of water in the smaller jug.
...
(***************************************************************************)
SmallToBig == LET poured == Min(big + small, BigJug) - big
                  \* The amount of water poured.
              IN  /\ big'   = big + poured
                  /\ small' = small - poured             

BigToSmall == 
  LET poured == Min(big + small, SmallJug) - small
  IN  /\ big'   = big - poured
      /\ small' = small + poured
