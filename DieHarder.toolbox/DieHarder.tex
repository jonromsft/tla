...
\@x{ {\CONSTANT} JugIds}%
\@y{\@s{0}%
 The set of Jug \ensuremath{IDs
}}%
\@xx{}%
\@x{ {\CONSTANT} JugCapacity}%
\@y{\@s{0}%
 Map from Jug \ensuremath{ID} to capacity of that jug
}%
\@xx{}%
\@x{ {\CONSTANT} Goal}%
\@y{\@s{0}%
 The number of gallons we\mbox{'}re shooting for
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} jugContents}%
\@y{\@s{0}%
 The current capacity of each jug
}%
\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
\@x{ Init \.{\defeq} jugContents \.{=} [ j \.{\in} JugIds \.{\mapsto} 0 ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ FillJug ( j ) \.{\defeq} jugContents \.{'} \.{=} [ jugContents {\EXCEPT}
 {\bang} [ j ] \.{=} JugCapacity [ j ] ]}%
\@pvspace{8.0pt}%
 \@x{ EmptyJug ( j ) \.{\defeq} jugContents \.{'} \.{=} [ jugContents
 {\EXCEPT} {\bang} [ j ] \.{=} 0 ]}%
\@pvspace{8.0pt}%
\@x{ Min ( m ,\, n ) \.{\defeq} {\IF} m \.{<} n \.{\THEN} m \.{\ELSE} n}%
\@pvspace{8.0pt}%
\@x{ Transfer ( from ,\, to ) \.{\defeq} \.{\land} from \.{\neq} to}%
 \@x{\@s{100.54} \.{\land} \.{\LET} poured \.{\defeq} Min ( jugContents [ from
 ] \.{+} jugContents [ to ] ,\, JugCapacity [ to ] ) \.{-} jugContents [ to ]
 \.{\IN}}%
 \@x{\@s{111.65} jugContents \.{'} \.{=} [ jugContents {\EXCEPT} {\bang} [
 from ] \.{=} jugContents [ from ] \.{-} poured ,\, {\bang} [ to ] \.{=}
 jugContents [ to ] \.{+} poured ]}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} \E\, a ,\, b \.{\in} JugIds \.{:} FillJug ( a ) \.{\lor}
 EmptyJug ( a ) \.{\lor} Transfer ( a ,\, b )}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} \A\, j \.{\in} JugIds \.{:} jugContents [ j ] \.{\in}
 0 \.{\dotdot} JugCapacity [ j ]}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\end{document}
