...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ABJonRoSpec}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, Sequences}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} Data}%
\@pvspace{8.0pt}%
 \@x{ Remove ( i ,\, seq ) \.{\defeq} [ j \.{\in} 1 \.{\dotdot} ( Len ( seq )
 \.{-} 1 ) \.{\mapsto} {\IF} j \.{<} i \.{\THEN} seq [ j ] \.{\ELSE} seq [ j
 \.{+} 1 ] ]}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} AVar ,\,\@s{0.62}}%
\@y{\@s{0}%
 Current state \ensuremath{{\langle}data,\, sequence}
 \ensuremath{bit{\rangle}} of A
}%
\@xx{}%
\@x{\@s{51.42} BVar ,\,}%
\@y{\@s{0}%
 Current sequence bit of \ensuremath{B
}}%
\@xx{}%
\@x{\@s{51.42} AtoB ,\,\@s{0.43}}%
\@y{\@s{0}%
 Lossy \ensuremath{FIFO} channel from A to \ensuremath{B
}}%
\@xx{}%
\@x{\@s{51.42} BtoA\@s{7.31}}%
\@y{\@s{0}%
 Lossy \ensuremath{FIFO} channel from \ensuremath{B} to A
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@x{ SequenceBits \.{\defeq} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 The set of all messages is everything from \ensuremath{Data} as the value,
 and everything in \ensuremath{SequenceBits} as the \ensuremath{seqBit
}}%
\@xx{}%
\@x{ Messages \.{\defeq} [ value \.{:} Data ,\, seqBit \.{:} SequenceBits ]}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq} \.{\land} ( AVar\@s{0.62} \.{\in} Messages )}%
\@y{\@s{0}%
 \ensuremath{AVar} must be a message
}%
\@xx{}%
\@x{\@s{56.14} \.{\land} ( BVar \.{\in} SequenceBits )}%
\@y{\@s{0}%
 \ensuremath{BVar} is a sequence bit
}%
\@xx{}%
 \@x{\@s{56.14} \.{\land} ( \A\, i\@s{12.80} \.{\in} 1 \.{\dotdot} Len ( AtoB
 ) \.{:} AtoB [ i ] \.{\in} Messages )}%
\@y{\@s{0}%
 \ensuremath{AtoB} is a sequence of messages
}%
\@xx{}%
 \@x{\@s{56.14} \.{\land} ( \A\, i\@s{12.80} \.{\in} 1 \.{\dotdot} Len ( BtoA
 )\@s{0.77} \.{:} BtoA [ i ]\@s{0.77} \.{\in} SequenceBits )}%
\@y{\@s{0}%
 \ensuremath{BtoA} is a sequence of sequence bits
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@pvspace{8.0pt}%
 \@x{ Init\@s{2.02} \.{\defeq} \.{\land} \E\, d\@s{10.74} \.{\in} Data \.{:}
 AVar \.{=} [ value \.{\mapsto} d ,\, seqBit \.{\mapsto} 1 ]\@s{33.01}}%
\@y{\@s{0}%
 A starts with random data and a \ensuremath{seqBit} of 1
}%
\@xx{}%
\@x{\@s{37.72} \.{\land} BVar \.{=} AVar . seqBit}%
\@y{\@s{0}%
 B has already received message with sequence bit 1 from A
}%
\@xx{}%
\@x{\@s{37.72} \.{\land} AtoB\@s{0.43} \.{=} {\langle} {\rangle}}%
\@y{\@s{0}%
 Nothing in the channel
}%
\@xx{}%
\@x{\@s{37.72} \.{\land} BtoA\@s{1.20} \.{=} {\langle} {\rangle}}%
\@y{\@s{0}%
 Nothing in the channel
}%
\@xx{}%
...
A to \ensuremath{B
 } A can read/write \ensuremath{AVar}, consume the \ensuremath{BtoA} channel,
 and produce the \ensuremath{AtoB} channel
\end{cpar}%
\end{lcom}%
\@x{}%
\@y{\@s{0}%
 If there are messages from \ensuremath{B} and the first message is an
 acknowledgement
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 of the last message A sent, then we\mbox{'}re ready to advance to the next
 message
}%
\@xx{}%
\@x{}%
...
\@xx{}%
\@x{ ASendNextMessage \.{\defeq} \.{\land} Len ( BtoA ) \.{>} 0}%
\@x{\@s{104.07} \.{\land} AVar . seqBit \.{=} Head ( BtoA )}%
 \@x{\@s{104.07} \.{\land} \E\, d \.{\in} Data \.{:} AVar \.{'} \.{=} [ value
 \.{\mapsto} d ,\, seqBit \.{\mapsto} 1 \.{-} AVar . seqBit ]}%
\@x{\@s{104.07} \.{\land} AtoB \.{'} \.{=} AtoB}%
\@x{\@s{104.07} \.{\land} BtoA \.{'}\@s{0.77} \.{=} Tail ( BtoA )\@s{1.82}}%
\@y{\@s{0}%
 Consume the ack from \ensuremath{B
}}%
\@xx{}%
\@x{\@s{104.07} \.{\land} {\UNCHANGED} {\langle} BVar {\rangle}}%
\@y{\@s{0}%
 Don\mbox{'}t touch \ensuremath{BVar
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 If there are messages from \ensuremath{B} and the first message is not an
 acknowledgement
}%
\@xx{}%
\@x{}%
...
\@xx{}%
\@x{ AIgnoreBadAck \.{\defeq} \.{\land} Len ( BtoA ) \.{>} 0}%
\@x{\@s{88.27} \.{\land} AVar . seqBit \.{\neq} Head ( BtoA )}%
\@x{\@s{88.27} \.{\land} AVar \.{'}\@s{0.19} \.{=} AVar}%
\@x{\@s{88.27} \.{\land} AtoB \.{'} \.{=} AtoB}%
\@x{\@s{88.27} \.{\land} BtoA \.{'}\@s{0.77} \.{=} Tail ( BtoA )\@s{1.82}}%
\@y{\@s{0}%
 Consume the bad message from \ensuremath{B
}}%
\@xx{}%
\@x{\@s{88.27} \.{\land} {\UNCHANGED} {\langle} BVar {\rangle}}%
\@y{\@s{0}%
 Don\mbox{'}t touch \ensuremath{BVar
}}%
\@xx{}%
...
\@xx{}%
\@x{ ARetransmit \.{\defeq} \.{\land} AVar \.{'}\@s{0.19} \.{=} AVar}%
\@x{\@s{75.07} \.{\land} AtoB \.{'} \.{=} Append ( AtoB ,\, AVar \.{'} )}%
\@y{\@s{0}%
 Produce the new message to the channel to \ensuremath{B
}}%
\@xx{}%
\@x{\@s{75.07} \.{\land} BtoA \.{'}\@s{0.77} \.{=} BtoA}%
\@x{\@s{75.07} \.{\land} {\UNCHANGED} {\langle} BVar {\rangle}}%
\@y{\@s{0}%
 Don\mbox{'}t touch \ensuremath{BVar
}}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
B to A
 B can read/write \ensuremath{BVar}, consume the \ensuremath{AtoB} channel,
 and produce the \ensuremath{BtoA} channel
\end{cpar}%
\end{lcom}%
\@x{}%
\@y{\@s{0}%
...
\@x{}%
\@y{\@s{0}%
 number than our current message, it\mbox{'}s new! Consume and acknowledge it.
}%
\@xx{}%
\@x{ BAcknowledge \.{\defeq} \.{\land} Len ( AtoB ) \.{>} 0}%
\@x{\@s{81.64} \.{\land} BVar \.{\neq} Head ( AtoB ) . seqBit}%
\@x{\@s{81.64} \.{\land} BVar \.{'} \.{=} Head ( AtoB ) . seqBit}%
\@y{\@s{0}%
 Remember the new sequence number
}%
\@xx{}%
\@x{\@s{81.64} \.{\land} AtoB \.{'}\@s{0.43} \.{=} Tail ( AtoB )}%
\@y{\@s{0}%
 Consume the message from A
}%
\@xx{}%
\@x{\@s{81.64} \.{\land} BtoA \.{'}\@s{1.20} \.{=} BtoA}%
\@y{\@s{0}%
 Don\mbox{'}t need to send a message to A to receive new data from A
}%
\@xx{}%
\@x{\@s{81.64} \.{\land} {\UNCHANGED} {\langle} AVar {\rangle}}%
\@y{\@s{0}%
 Don\mbox{'}t touch
}%
\@xx{}%
...
\@xx{}%
\@x{ BIgnoreBadMsg \.{\defeq} \.{\land} Len ( AtoB ) \.{>} 0}%
\@x{\@s{89.22} \.{\land} BVar \.{=} Head ( AtoB ) . seqBit}%
\@x{\@s{89.22} \.{\land} BVar \.{'} \.{=} BVar}%
\@x{\@s{89.22} \.{\land} AtoB \.{'}\@s{0.43} \.{=} Tail ( AtoB )}%
\@y{\@s{0}%
 Consume the \ensuremath{AtoB} channel
}%
\@xx{}%
\@x{\@s{89.22} \.{\land} BtoA \.{'}\@s{1.20} \.{=} BtoA}%
\@x{\@s{89.22} \.{\land} {\UNCHANGED} {\langle} AVar {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 At any time, \ensuremath{B} can retransmit what it previously sent
}%
\@xx{}%
\@x{ BRetransmit \.{\defeq} \.{\land} BVar \.{'} \.{=} BVar}%
\@x{\@s{74.67} \.{\land} AtoB \.{'}\@s{0.43} \.{=} AtoB}%
 \@x{\@s{74.67} \.{\land} BtoA \.{'}\@s{1.20} \.{=} Append ( BtoA ,\, BVar
 \.{'} )\@s{0.10}}%
\@y{\@s{0}%
 Produce the \ensuremath{BtoA} channel
}%
\@xx{}%
\@x{\@s{74.67} \.{\land} {\UNCHANGED} {\langle} AVar {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Simulate loss by removing messages from \ensuremath{AtoB} while maintaining
 \ensuremath{FIFO
}%
\end{cpar}%
\end{lcom}%
\@x{ DropAtoBMessage \.{\defeq} \.{\land} Len ( AtoB ) \.{>} 0}%
 \@x{\@s{99.82} \.{\land} \E\, i \.{\in} 1 \.{\dotdot} Len ( AtoB ) \.{:} AtoB
 \.{'} \.{=} Remove ( i ,\, AtoB )}%
 \@x{\@s{99.82} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BVar ,\, BtoA
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Simulate loss by removing messages from \ensuremath{BtoA} while maintaining
 \ensuremath{FIFO
}%
\end{cpar}%
\end{lcom}%
\@x{ DropBtoAMessage \.{\defeq} \.{\land} Len ( BtoA ) \.{>} 0}%
 \@x{\@s{100.07} \.{\land} \E\, i \.{\in} 1 \.{\dotdot} Len ( BtoA ) \.{:}
 BtoA \.{'} \.{=} Remove ( i ,\, BtoA )}%
 \@x{\@s{100.07} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BVar ,\, AtoB
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} ASendNextMessage}%
\@x{\@s{39.83} \.{\lor} AIgnoreBadAck}%
\@x{\@s{39.83} \.{\lor} ARetransmit}%
\@x{\@s{39.83} \.{\lor} BAcknowledge}%
\@x{\@s{39.83} \.{\lor} BIgnoreBadMsg}%
\@x{\@s{39.83} \.{\lor} BRetransmit}%
\@x{\@s{39.83} \.{\lor} DropAtoBMessage}%
\@x{\@s{39.83} \.{\lor} DropBtoAMessage}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 06 12:59:57 \ensuremath{PDT} 2016 by \ensuremath{jonro
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Apr} 06
 10:20:29 \ensuremath{PDT} 2016 by \ensuremath{jonro
}%
\end{cpar}%
\end{lcom}%
\end{document}
