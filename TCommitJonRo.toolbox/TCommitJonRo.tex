...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TCommitJonRo}\moduleRightDash\@xx{}%
...
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Can commit iff all \ensuremath{RMs} are in the \ensuremath{\@w{prepared}} or
 \ensuremath{\@w{committed}} state.
\end{cpar}%
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{ canAbort \.{\defeq} \A\, r \.{\in} RM \.{:} rmState [ r ]
 \.{\neq}\@w{committed}}%
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Can abort iff no \ensuremath{RM} has decided to commit.
\end{cpar}%
\end{lcom}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{ Prepare ( r )\@s{2.10} \.{\defeq} \.{\land} rmState [ r ]
 \.{=}\@w{working}}%
\@x{\@s{67.91}}%
\@y{\@s{0}%
 Any \ensuremath{RM} in the working state can go to the prepared state
}%
\@xx{}%
 \@x{\@s{67.91} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r
 ] \.{=}\@w{prepared} ]}%
\@pvspace{8.0pt}%
 \@x{ Commit ( r )\@s{4.1} \.{\defeq} \.{\land} rmState [ r ]
 \.{=}\@w{prepared}}%
\@x{\@s{72.01} \.{\land} canCommit}%
\@y{\@s{0}%
 Only allowed to commit from prepared if we can commit
}%
\@xx{}%
 \@x{\@s{72.01} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r
 ] \.{=}\@w{committed} ]}%
\@pvspace{8.0pt}%
 \@x{ Abort ( r )\@s{11.09} \.{\defeq} \.{\land} rmState [ r ] \.{\in}
 \{\@w{working} ,\,\@w{prepared} \}}%
\@x{\@s{67.91} \.{\land} canAbort}%
\@y{\@s{0}%
 Only allowed to abort from working or prepared if we can abort
}%
\@xx{}%
 \@x{\@s{67.91} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ r
 ] \.{=}\@w{aborted} ]}%
\@pvspace{8.0pt}%
 \@x{ TCNext \.{\defeq} \E\, r \.{\in} RM \.{:} Prepare ( r ) \.{\lor} Commit
 ( r ) \.{\lor} Abort ( r )}%
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Asserts that \ensuremath{TCTypeOK} and \ensuremath{TCInvariant} are
